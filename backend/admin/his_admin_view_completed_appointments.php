                                ...
                                <div class="card-box">
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            */
                                                // $r="select *from";
                                                $ret="SELECT * FROM  his_app where app_status = 'Completed'"; 
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <a href="his_admin_view_completed_appointments.php?cancel=<?php echo $row->app_id;?>" class="badge badge-danger"><i class="mdi  mdi-trash-can-outline"></i> cancel</a>
