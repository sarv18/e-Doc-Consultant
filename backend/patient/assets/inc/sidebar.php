                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    ...
                                    <li>
                                        <a href="his_pat_view_doctors.php">View Doctor</a>
                                    </li>
                            ...
                            <!-- <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li>
                                        <a href="his_doc_register_patient.php">Past Appointments</a>
                                    </li>
                                    <li>
                                        <a href="his_doc_view_patients.php">View Appointments</a>
                                    </li>
                                    <li>
                                        <a href="his_pat_book_appointment.php">Book Appointments</a>
                                    </li>
                                </ul>
                            </li> -->
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li>
                                        <a href="his_pat_book_appointment.php">Book Appointment</a>
                                    </li>
                                    <li>
                                        <a href="his_pat_view_appointments.php">My Appointments</a>
                                    </li>
                                    <li>
                                        <a href="his_pat_view_canceled_appointments.php">Canceled Appointments</a>
                                    </li>
                                    <li>
                                        <a href="his_pat_view_accepted_appointments.php">Accepted Appointments</a>
                                    </li>
                                   <li>
                                        <a href="his_pat_view_completed_appointments.php">Completed </a>
                                    </li>
                                </ul>
                            </li>
