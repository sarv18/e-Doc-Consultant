<?php
  ...
  if(isset($_GET['update']))
  {
        ...
        $adn="update his_app set app_status='accept' where app_id=?";
    ...
    if(isset($_GET['cancel']))
  {
    ...
    if(isset($_GET['delete']))
    {
        ...
        if($app_status ='Inprogress' || $app_status='Cancel')
        {

            $adn="delete from his_app where app_id=? ";
            $stmt= $mysqli->prepare($adn);
            $stmt->bind_param('i',$id);
            $stmt->execute();
            $stmt->close();	 
        ...
        {
            $err = "Can't delete Accepted or Completed appointment!! ";
        }
    }
?>
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            */
                                                // $r="select *from";
                                                $ret="SELECT * FROM  his_app where pat_id='$pat_id'"; 
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <!-- <a href="his_doc_view_appointments.php?update=<?php echo $row->app_id;?>" class="badge badge-success"><i class="mdi mdi-pencil-outline"></i> Accept</a> -->

                                                    <a href="his_pat_view_appointments.php?cancel=<?php echo $row->app_id;?>" class="badge badge-danger"><i class="mdi  mdi-trash-can-outline"></i> cancel</a>

                                                    <a href="his_pat_view_appointments.php?delete=<?php echo $row->app_id;?> his_pat_view_appointments.php?app_status=<?php echo $row->app_status;?> class="badge badge-danger"><i class="mdi  mdi-trash-can-outline"></i> delete</a>
                                            ...
                                            <?php  $cnt = $cnt +1 ; }
                                                    ...
                                                    $adn="delete from his_app where pat_id=?";
                                                    $stmt= $mysqli->prepare($adn);
